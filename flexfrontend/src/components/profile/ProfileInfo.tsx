...
const ProfileInfo = ({ profileData }: ProfileInfoProps) => {
    ...
    return <div id="userInfo" className="flex flex-col items-center justify-evenly">
        ...
        <div id="toggle-bar" className="p-5 border border-zinc-500 w-full">

        </div>
        <div id="exercise-stats" className="flex flex-col justify-start w-full mt-2 h-screen px-10">
            <div className="flex flex-row justify-between w-full">
                <div id="fav-exercise" className="flex flex-col border border-zinc-500 p-2 rounded-lg h-full w-5/12">
                ...
                <div className="flex flex-col justify-evenly w-5/12">
                    <div id="streak" className="flex flex-col border border-zinc-500 p-2 rounded-lg">
                        <span className="text-xs">Longest Streak</span>
                        <span className="text-xl">324 days</span>
                    </div>
                    <div id="calories" className="flex flex-col border border-zinc-500 p-2 rounded-lg mt-2">
            ...
            <div className="flex flex-row justify-evenly mt-2">
                <div id="workout" className="flex flex-col border border-zinc-500 p-2 rounded-lg w-full">
            ...
            <div className="flex flex-row justify-evenly mt-2">
                <div id="breakdown" className="flex flex-col border border-zinc-500 p-2 rounded-lg w-full">
