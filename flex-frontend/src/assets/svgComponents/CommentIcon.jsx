function CommentIcon(props) {
    return <svg className={props.className} xmlns="http://www.w3.org/2000/svg" viewBox="-38 0 580 580" height="48" width="48">
        <path
            ...
            fill="none" stroke="currentColor" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="24" />
    </svg>
