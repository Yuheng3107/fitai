...
from .views import ExerciseDetailView, ExerciseUpdateView, ExerciseStatisticsView, ExerciseRegimeView, ExerciseListView, ExerciseStatisticsDetailView
urlpatterns = [
    ...
    path('exercise_statistics/<int:pk>', ExerciseStatisticsDetailView.as_view(), name='exercise_statistics'),
